...
function TwistedFate:LoadMenu()
	self.Menu = MenuElement({type = MENU, id = "TwistedFate", name = Scriptname, leftIcon=Icons[""]})
	
	--[[Pick a card menu]]
	self.Menu:MenuElement({id = "CardPicker", name = "CardPicker",leftIcon=Icons[""], type = MENU})
	self.Menu.CardPicker:MenuElement({id = "GoldCard", name = "Gold", leftIcon=Icons[""], key = string.byte("CapsLock")})
	self.Menu.CardPicker:MenuElement({id = "RedCard", name = "Red", leftIcon=Icons[""], key = string.byte("T")})
	self.Menu.CardPicker:MenuElement({id = "BlueCard", name = "Blue",leftIcon=Icons[""], key = string.byte("E")})
	self.Menu:MenuElement({id = "UseQ", name = "Use Q",leftIcon=Icons[""], key = string.byte("Z")})
	
	
	self.Menu:MenuElement({id = "AutoW", name = "Autopick goldcard on ult", value = false})
